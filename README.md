# Ollama-RAG-Chatbot
A Retrieval-Augmented Generation (RAG) chatbot built with Ollama, Flask, local GGUF models, and semantic vector search for context-aware question answering.
# Ollama RAG Chatbot
